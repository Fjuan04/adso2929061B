...
<body>
    ...
    <div id="real-screen" class="flex w-[500px] text-white flex-col gap-4 m-auto mt-20 hidden">
        ...
        <div id="staming" class="bg-slate-600 rounded-lg h-10 flex items-center justify-evenly font-bold w-full capitalize">
            ...
            <div class="bg-info p-1 rounded flex items-center rounded-full w-8 h-8 justify-center text-[14px]"><?=$data['staming']?></div>
        ...
        <div id="speed" class="bg-slate-600 rounded-lg h-10 flex items-center justify-evenly font-bold w-full capitalize">
            ...
            <div class="bg-info p-1 rounded flex items-center rounded-full w-8 h-8 justify-center text-[14px]"><?=$data['speed']?></div>
