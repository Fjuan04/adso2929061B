...
function Combat<TBase extends Constructor>(Base: TBase) {
...
function Agility<TBase extends Constructor>(Base: TBase) {
  return class extends Base {
    jump() {
...
function Exploration<TBase extends Constructor>(Base: TBase) {
  return class extends Base {
    markLocation() {
