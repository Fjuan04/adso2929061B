            ...
            <div class="gap-2 flex flex-col md:flex-row mt-8">
                <div class="card bg-base-100 image-full w-74 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('customer.edit', Auth::user()->id) }}" class="btn text-white bg-sky-900">More Info</a>
                        </div>
                    </div>
                </div>
                <div class="card bg-base-100 image-full w-74 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <p>Look for your adoptions here!</p>
                        <div class="card-actions justify-end">
                        <a href="{{ route('customer.show',Auth::user()->id) }}" class="btn text-white bg-amber-900">More Info</a>
                        </div>
                    </div>
                </div>
                <div class="card bg-base-100 image-full w-74 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <p>Make adoption: read.</p>
                        <div class="card-actions justify-end">
                        <a href="{{ route('freepets') }}" class="btn text-white bg-purple-900">More Info</a>
                        </div>
                    </div>
                </div>
            </div>
