...
<main class="bg-cover w-full min-h-[100dvh] flex flex-col justify-center items-center">
    <div class="bg-[#0006] md:w-10/12 w-96 text-white p-10 rounded-lg flex flex-col justify-center items-center">
        ...
        <div class="join mt-5">
            <a href="{{url('users/create')}}" class="btn join-item btn-success"><svg xmlns="http://www.w3.org/2000/svg" class="size-6" fill="currentColor" viewBox="0 0 256 256">
                    <path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm0,192a88,88,0,1,1,88-88A88.1,88.1,0,0,1,128,216Zm48-88a8,8,0,0,1-8,8H136v32a8,8,0,0,1-16,0V136H88a8,8,0,0,1,0-16h32V88a8,8,0,0,1,16,0v32h32A8,8,0,0,1,176,128Z"></path>
                </svg> Add user</a>
            <!-- PDF -->
            <a href="{{ url('export/users/pdf')}}" class="btn join-item"><svg xmlns="http://www.w3.org/2000/svg" class="size-6" fill="#000000" viewBox="0 0 256 256">
        ...
        <div class="overflow-x-auto mt-8 rounded-box border">
            <table class="table table-md lg:min-w-[640px] bg-[#0006]">
                <!-- head -->
                ...
                <tbody class="datalist">
                    ...
                    <tr>
                        ...
                        <th class="w-full">
                            <!--Consultar -->
                            <a href="{{url('users/' . $user->id)}}" class="btn btn-ghost hover:bg-[transparent] btn-xs"><svg class="size-4" xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="#fff" viewBox="0 0 256 256">
                                    <path d="M229.66,218.34l-50.07-50.06a88.11,88.11,0,1,0-11.31,11.31l50.06,50.07a8,8,0,0,0,11.32-11.32ZM40,112a72,72,0,1,1,72,72A72.08,72.08,0,0,1,40,112Z"></path>
                                </svg></a>

                            <!--edit -->

                            <a href="{{'users/'. $user->id .'/edit'}}" class="btn btn-ghost hover:bg-[transparent] btn-xs"><svg class="size-4" xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="#fff" viewBox="0 0 256 256">
                                    <path d="M227.31,73.37,182.63,28.68a16,16,0,0,0-22.63,0L36.69,152A15.86,15.86,0,0,0,32,163.31V208a16,16,0,0,0,16,16H92.69A15.86,15.86,0,0,0,104,219.31L227.31,96a16,16,0,0,0,0-22.63ZM92.69,208H48V163.31l88-88L180.69,120ZM192,108.68,147.31,64l24-24L216,84.68Z"></path>
                                </svg></a>


                            <a href="javascript:;" class="btn btn-ghost btn-xs btn-delete" data-fullname="{{$user->fullname}}">
