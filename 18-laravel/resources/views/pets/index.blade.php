...
<main class="bg-cover bg-slate-700 w-full min-h-[100dvh] flex flex-col justify-center items-center">
    <div class="bg-[#ffF5] md:w-10/12 w-96 text-white p-10 rounded-lg flex flex-col justify-center items-center">
