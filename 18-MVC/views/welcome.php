...
<body class="">
  ...
  <div class="hero bg-base-200 min-h-screen">  
    ...
    <div class="hero-content w-[100vw] text-center">
      
      <div class="w-full  flex flex-col mt-10 ">
        <h1 class="text-5xl font-bold text-center mb-10">Model View Controller</h1>

          <a href="/pokemons/create" class="btn flex m-auto w-fit btn-success mb-8">Add Pokemon <svg xmlns="http://www.w3.org/2000/svg" class="size-8"  viewBox="0 0 24 24"><path fill="#ffffff" d="M11 13v3q0 .425.288.713T12 17t.713-.288T13 16v-3h3q.425 0 .713-.288T17 12t-.288-.712T16 11h-3V8q0-.425-.288-.712T12 7t-.712.288T11 8v3H8q-.425 0-.712.288T7 12t.288.713T8 13zm1 9q-2.075 0-3.9-.788t-3.175-2.137T2.788 15.9T2 12t.788-3.9t2.137-3.175T8.1 2.788T12 2t3.9.788t3.175 2.137T21.213 8.1T22 12t-.788 3.9t-2.137 3.175t-3.175 2.138T12 22"/></svg></a> 
        <div class="overflow-x-auto w-full rounded-box bg-base-100">
          <div class="w-full text-black">
            
            <div class="h-full grid grid-cols-4 gap-2 p-2">
              <?php foreach ($data as $pokemon): ?> 
              <div class="grid bg-blue-50 p-3 content-center rounded-lg h-[240px] grid-cols-3 grid-rows-4">
                <div class="col-start-3 badge m-auto px-5"><?= htmlspecialchars($pokemon['id']) ?></div>
                  <div class="avatar col-start-1 col-span-2 row-start-2 row-span-2">
                    <div class="h-full m-auto">
                      <img
                        class="w-full scale-120"
                        src="<?=$pokemon['image_url']?>"
                        alt="Avatar" />
                    </div>
                  </div>
                <div class="row-start-1 text-2xl capitalize col-start-1 col-span-2 font-bold"><?= htmlspecialchars($pokemon['name']) ?></div>
                <div class="col-start-1 scale-120 col-span-2 m-auto row-start-4">
                    <span class="<?= $types[$pokemon['type']]?> "><?= $pokemon['type'] ?></span>
                </div>
                <div class="col-start-3 gap-1 flex flex-col">
                  ...
                  <a href="/pokemons/<?= $pokemon['id'] ?>/edit" class="btn btn-neutral"><svg class="size-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M7 7H6a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2-2v-1"/><path d="M20.385 6.585a2.1 2.1 0 0 0-2.97-2.97L9 12v3h3zM16 5l3 3"/></g></svg></a>
                  <form method="post" class="inline w-full" action="/pokemons/<?=$pokemon['id']?>/delete">
                      <button type="submit" class="btn w-full btn-error"><svg class="size-4" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24"><path fill="#ffffff" d="M7 21q-.825 0-1.412-.587T5 19V6q-.425 0-.712-.288T4 5t.288-.712T5 4h4q0-.425.288-.712T10 3h4q.425 0 .713.288T15 4h4q.425 0 .713.288T20 5t-.288.713T19 6v13q0 .825-.587 1.413T17 21zM17 6H7v13h10zm-7 11q.425 0 .713-.288T11 16V9q0-.425-.288-.712T10 8t-.712.288T9 9v7q0 .425.288.713T10 17m4 0q.425 0 .713-.288T15 16V9q0-.425-.288-.712T14 8t-.712.288T13 9v7q0 .425.288.713T14 17M7 6v13z"/></svg></button>
                  </form>
                </div>
              </div>
